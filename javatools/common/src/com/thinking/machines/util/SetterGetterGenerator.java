...
{
System.out.println("usage : java classpath path_to_jar_file;. com.thinking.machines.util.SetterGetterGenerator class_name constructor=ture/false");
return;
}
...
System.out.println("setter and getter for : "+c.getName()+"  generated in tmp.tmp file");
